...
@AllArgsConstructor
@NoArgsConstructor
@MappedSuperclass // (define a model class tha)defines a base class that provides common properties without being mapped to the database--(class that can be inherited)
